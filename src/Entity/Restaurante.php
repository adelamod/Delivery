...
class Restaurante
{
    ...
    public function addLineaPedido(Pedido $lineaPedido): self
    {
        if (!$this->lineaPedido->contains($lineaPedido)) {
            $this->lineaPedido[] = $lineaPedido;
            $lineaPedido->setRestaurante($this);
        }

        return $this;
    }

    public function removeLineaPedido(Pedido $lineaPedido): self
    {
        if ($this->lineaPedido->removeElement($lineaPedido)) {
            // set the owning side to null (unless already changed)
            if ($lineaPedido->getRestaurante() === $this) {
                $lineaPedido->setRestaurante(null);
            }
        }
